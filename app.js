        ...
        <div class="pro-card-btns">
          ...
          ${req
            ? `<div style="display:flex;gap:.4rem">
                 ...
                 <button class="btn btn-indigo btn-sm" onclick="event.stopPropagation();goToConv(${reqIdJs})">Message</button>
               </div>`
  ...
  document.getElementById('profile-modal-box').innerHTML = `
    ...
    <div class="pm-body">
      ...
      <div class="pm-actions">
        ...
        ${req
          ? `<button class="btn btn-indigo" onclick="closeProfileModal(null);goToConv(${typeof req.id === 'number' ? req.id : `'${req.id}'`})">Message</button>
